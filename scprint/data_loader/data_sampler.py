...
import numpy as np
import torch
from torch.utils.data import Sampler, SubsetRandomSampler, BatchSampler, WeightedRandomSampler

class myWeightedRandomSampler(WeightedRandomSampler):
    """
    """
    def __init__(self, weights: Sequence[float], num_samples: int,
                replacement: bool = True, generator=None):
        super().init(weights, num_samples, replacement, generator)
